...
public class MovieManager {
	...
	public static void main(String[] args){
		...
		//m.movieAllData();
		///home/seo/javaStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/MovieProject/movie_main.jsp
		File file = new File("/home/seo/git/3Project/Final/src/main/webapp/text/desc.txt");
	...
	public List<String> jsonParse(String json){
		...
		try{
			...
			// true는 append
			FileWriter fw = new FileWriter("/home/seo/git/3Project/Final/src/main/webapp/text/movieDetail.txt",true);
			fw.write(desc);
			fw.close();
