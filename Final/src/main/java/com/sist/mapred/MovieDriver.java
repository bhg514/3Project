...
public class MovieDriver {
	...
	public void movieMapReduce(){
		...
		try{
			...
			FileInputFormat.addInputPath(job, new Path("/home/actif/git/final/Final/src/main/webapp/text/desc.txt"));
			
			File dir= new File("/home/actif/git/final/Final/src/main/webapp/output");
			if(dir.exists()){
			...
			FileOutputFormat.setOutputPath(job, new Path("/home/actif/git/final/Final/src/main/webapp/output"));
