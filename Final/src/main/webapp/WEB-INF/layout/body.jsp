					...
					<div class="col-md-6 col-sm-6">
						...
						<c:forEach var="vo" items="${reList }" varStatus="status">
							<tr height="30px">
								...
								<td style="text-align: left; width:85%">&nbsp;${vo }<td>
							</tr>
						</c:forEach>
						</table>
						</center>
							...
							<tr>
								<form method="post" action="main.do" accept-charset="UTF-8">
									<th style="height:40px;text-align: center; vertical-align: middle;">
										<input type="text" style="width: 40%; color:#000; display: inline;" name="title" value="${search }">
										<input type="submit" value="검색" style="background:#fff;color:#ccc;width:8%">
									</th>
								</form>
							</tr>
